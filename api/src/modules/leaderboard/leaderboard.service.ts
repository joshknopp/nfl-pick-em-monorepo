...
export class LeaderboardService {
  ...
  async getLeaderboard(
    ...
    // Fetch usernames and isActive status from Firestore for all users
    ...
    const activeUsers = users.filter((user) => activeUserUids.has(user.uid));
